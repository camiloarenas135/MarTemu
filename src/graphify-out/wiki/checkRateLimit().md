...
> God node · 3 connections · [C:\Users\camil\Desktop\MarTemu\src\utils\rateLimiter.ts](file:///C:/Users/camil/Desktop/MarTemu/src/utils/rateLimiter.ts#L19)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as checkRateLimit()
    ...
    participant P6 as sanitizePhone()
    participant P7 as recordAttempt()
